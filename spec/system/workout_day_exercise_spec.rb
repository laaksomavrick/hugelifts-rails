...
RSpec.describe 'Workout Day Exercises', type: :system do
  ...
  describe 'edit page' do
    ...
    it 'populates the edit workout day exercise form' do
      ...
      workout_day_hidden_input = find('input#workout_day_exercise_form_workout_day', visible: false)
      unit_hidden_input = find('input#workout_day_exercise_form_unit', visible: false)
      exercise_input = find('select#workout_day_exercise_form_exercise', visible: false)
      ...
      expect(exercise_input.value.to_i).to eq workout_day_exercise.exercise.id
    ...
    it 'can update a workout day exercise' do
      ...
      select Exercise::BARBELL_BENCH_PRESS, from: 'workout_day_exercise_form_exercise'
      ...
      expect(page).to have_content(I18n.t('workout_days.header'))
      expect(page).to have_content(Exercise::BARBELL_BENCH_PRESS)
